class CommentsController < ApplicationController
  ...
  def destroy
    ...
    if (@commentable.commentable_type == 'Question')
      ...
      redirect_to @question, notice: 'solution comment was successfully destroyed.'
    end
  end
  ...
  def update
    ...
    if (@commentable.commentable_type == 'Question')
      ...
      redirect_to @question, notice: 'solution comment was successfully updated.'
    end
  end
